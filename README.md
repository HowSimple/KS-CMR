...
A list of key resources for the project are logged on our [Wiki Home page](https://github.com/codeforkansascity/KS-CMR/wiki).

A list of meeting agendas & minutes are available on our [Wiki Home page](https://github.com/codeforkansascity/KS-CMR/wiki).

Join our Slack channel #clear-my-record-ks
